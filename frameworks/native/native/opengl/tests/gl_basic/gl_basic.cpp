...
int init_gl_surface(void)
{
    ...
    surfaceCtl = client->createSurface(String8("gl_basic"), 0, 480, 800, PIXEL_FORMAT_RGB_565, 0);
    ...
    EGLUtils::selectConfigForNativeWindow(eglDisplay, attrib, native_surface.get(), &myConfig);

    //if ( (eglSurface = eglCreateWindowSurface(eglDisplay, myConfig,
    //        window, 0)) == EGL_NO_SURFACE )
    if ( (eglSurface = eglCreateWindowSurface(eglDisplay, myConfig,
            native_surface.get(), 0)) == EGL_NO_SURFACE )
    {
